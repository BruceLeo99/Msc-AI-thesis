...
output_folder = f"/var/scratch/yyg760/SHAP_results/SHAP_PBN_pos"
test_img_ids_filepath1 = "pos_1p_blip_test.txt"
test_img_ids_filepath2 = "pos_2p_blip_test.txt"
test_img_ids_filepath3 = "pos_5p_blip_test.txt"
test_img_ids_filepath4 = "pos_10p_blip_test.txt"
...
test_data_to_analyze1 = f101.Food101Dataset(img_to_analyze1, transform='vgg16', target_transform='integer', load_captions=True)
test_data_to_analyze2 = f101.Food101Dataset(img_to_analyze2, transform='vgg16', target_transform='integer', load_captions=True)
test_data_to_analyze3 = f101.Food101Dataset(img_to_analyze3, transform='vgg16', target_transform='integer', load_captions=True)
test_data_to_analyze4 = f101.Food101Dataset(img_to_analyze4, transform='vgg16', target_transform='integer', load_captions=True)
