...
experiment_name4 = "DUMMY_ProtoPNet_resnet18_20_categories_30prototypes_0.0001lr"
...
print(f"Number of images in train_data_10classes: {len(train_data_10classes)}")
print(f"Number of images in val_data_10classes: {len(val_data_10classes)}")
print(f"Number of images in test_data_10classes: {len(test_data_10classes)}")
...
print(f"Number of images in train_data_20classes: {len(train_data_20classes)}")
print(f"Number of images in val_data_20classes: {len(val_data_20classes)}")
print(f"Number of images in test_data_20classes: {len(test_data_20classes)}")
...
end_time = time.time()
print(f"Number of images in train_data_30classes: {len(train_data_30classes)}")
print(f"Number of images in val_data_30classes: {len(val_data_30classes)}")
print(f"Number of images in test_data_30classes: {len(test_data_30classes)}")
