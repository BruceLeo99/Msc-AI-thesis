...
with open('train_full_annotation_4.json', 'r') as f:
    data = json.load(f)
...
with open('train_blip_caption_4.json', 'w') as f:
    json.dump(all_data, f)


with open('test_full_annotation_4.json', 'r') as f:
    data = json.load(f)
...
with open('test_blip_caption_4.json', 'w') as f:
    json.dump(all_data, f) 