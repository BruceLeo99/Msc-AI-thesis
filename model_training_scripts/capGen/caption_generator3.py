...
with open('train_full_annotation_3.json', 'r') as f:
    data = json.load(f)
...
with open('train_complete_caption_3.json', 'w') as f:
    json.dump(all_data, f)


with open('test_full_annotation_3.json', 'r') as f:
    data = json.load(f)
...
with open('test_complete_caption_3.json', 'w') as f:
    json.dump(all_data, f) 